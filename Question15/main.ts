...
console.log(`All of my guests are coming except ${guest_list[3]} because he has some health issues`);
...
guest_list.forEach(function (person){
  console.log(`Now I would like to invite ${person} on ramadan Iftar Party`);
});
